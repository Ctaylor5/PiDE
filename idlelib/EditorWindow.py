...
class EditorWindow(object):
    ...
    def get_vis_selection_indices(self):#indecies for vis_text
        try:
            first = self.vis_text.index("sel.first")
            last = self.vis_text.index("sel.last")
            return first, last
        except TclError:
            return None, None
