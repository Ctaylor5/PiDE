    ...
    def runsource(self, source):
        ...
        if isinstance(source, types.UnicodeType):
            ...
            try:
                ...
                self.tkconsole.resetoutput()
                self.self_write("Unsupported characters in input\n")
                return
        try:
...
##        self.config(usetabs=1, indentwidth=8, context_use_ps1=1)
    ...
    def close_debugger(self):
        ...
        if db:
            ...
            self.resetoutput()
            self.console.self_write("[DEBUG OFF]\n")
            sys.ps1 = ">>> "
            self.showprompt()
        self.set_debugger_indicator()
    ...
    def cancel_callback(self, event=None):
        ...
        if not (self.executing or self.reading):
            self.resetoutput()
            self.interp.self_write("KeyboardInterrupt\n")
            self.showprompt()
            return "break"
        self.endoffile = 0
        self.canceled = 1
    ...
    def enter_callback(self, event):
        ...
        try:
            ...
            vsel = self.vis_text.get("sel.first", "sel.last")
            if sel:
    ...
    def showprompt(self):
        ...
        try:
            ...
            s = ""
        #self.console.write(s) #output prompt actual
        self.self_write(s)
        self.text.mark_set("insert", "end-1c")
